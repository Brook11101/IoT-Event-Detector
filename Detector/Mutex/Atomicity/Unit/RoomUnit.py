    ...
    with open(output_file, "w") as file:
        for round_num in range(1, rounds + 1):
            ...
            for rule in labeled_rules:
                thread = threading.Thread(target=apply_lock, args=(connector, rule, room_lock_dict, time_differences))
...
def execute_rules_for_groups(connector, rule_groups, rounds, base_output_dir):
    ...
    for group_idx, rules in enumerate(rule_groups):
        ...
        output_file = f"{base_output_dir}/room_lock_groups_{group_size}.txt"
...
if __name__ == "__main__":
    ...
    rounds = 20
    output_base_dir = r"E:\研究生信息收集\论文材料\IoT-Event-Detector\Detector\Mutex\Atomicity\Unit\Data"
