...
def InMonitor():
    # Java 目标类路径
    java_class_path = "concurrency.experiment.InMonitor"
    log_file_path = "E:\\研究生信息收集\\论文材料\\IoT-Event-Proxy\\src\\main\\java\\concurrency\\experiment\\data\\InMonitorLog.txt"
